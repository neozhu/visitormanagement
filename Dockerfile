...
RUN dotnet build "Blazor.Server.UI.csproj" -c $BUILD_CONFIGURATION -o /app/build

FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "Blazor.Server.UI.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
